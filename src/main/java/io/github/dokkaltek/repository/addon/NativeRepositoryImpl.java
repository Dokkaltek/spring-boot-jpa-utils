...
/**
 * Implementation of {@link NativeRepository}.
 *
 * @param <T> The entity of the repository.
 */
@RequiredArgsConstructor
public class NativeRepositoryImpl<T, I> implements NativeRepository<T, I> {
     ...
     */
    @Override
    public <S extends T> void insertAllWithSequenceId(Iterable<S> entryList, String idParamToGenerate, String sequenceName) {
        // TODO
    }
