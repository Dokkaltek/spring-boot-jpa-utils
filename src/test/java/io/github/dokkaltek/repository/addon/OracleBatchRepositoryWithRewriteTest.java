 ...
 */
@EnabledIf(expression = "#{environment['spring.profiles.active'] == 'oracle-rewrite'}")
@SpringBootTest
@ContextConfiguration(classes = {TestIntegrationRunner.class})
@Transactional
class OracleBatchRepositoryWithRewriteTest {
    @Autowired
    ...
    void testInsertAll() {
        ...
        sampleEntities.get(0).setId(14L);
        sampleEntities.get(1).setId(15L);
